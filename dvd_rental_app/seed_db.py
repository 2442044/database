...
def seed_data():
    ...
    dvds = [
        ...
        ('千と千尋の神隠し', genre_map.get('アニメ'), 3, 3, 'C-2', '10歳の少女・千尋は、引越し先へ向かう途中で不思議な世界に迷い込む。そこは八百万の神々が住む世界だった。豚に変えられてしまった両親を救うため、千尋は湯屋「油屋」で働くことになる。成長と自立を描いた日本アニメーションの金字塔。'),
        ('君の名は。', genre_map.get('恋愛'), 6, 6, 'D-1', '東京に住む男子高校生・瀧と、飛騨の山奥に住む女子高生・三葉。出会うはずのない二人が、夢の中で入れ替わっていることに気づく。時空を超えたつながりと、忘れたくない想いを描いた青春ファンタジー。'),
        ('ショーシャンクの空に', genre_map.get('ドラマ'), 3, 3, 'A-1', '妻殺しの濡れ衣を着せられ、ショーシャンク刑務所に収監された元銀行員アンディ。絶望的な状況でも希望を捨てず、誠実な人柄で周囲を変えていく。長きにわたる刑務所生活と、驚きの脱獄劇を描いた感動のヒューマンドラマ。'),
        ('バック・トゥ・ザ・フューチャー', genre_map.get('SF'), 5, 5, 'B-2', '高校生のマーティは、友人の科学者ドクが発明したタイムマシンで30年前にタイムスリップしてしまう。そこで若き日の両親に出会い、二人の恋を成就させなければ自分の存在が消えてしまうことに。ハラハラドキドキの冒険を描いたSFアドベンチャーの傑作。'),
        ('タイタニック', genre_map.get('恋愛'), 4, 4, 'D-2', '豪華客船タイタニック号で出会った、貧しい青年ジャックと上流階級の娘ローズ。身分違いの恋に落ちた二人だったが、船は氷山に衝突し、沈没の時が迫る。悲劇的な運命の中で永遠の愛を誓う、世界中が涙したラブストーリー。'),
        ('となりのトトロ', genre_map.get('アニメ'), 4, 4, 'C-3', '田舎へ引っ越してきたサツキとメイの姉妹。そこで出会ったのは、森の主である不思議な生き物トトロだった。子供にしか見えないトトロとの交流を描いた、心温まるファンタジー。家族みんなで楽しめる不朽の名作。'),
